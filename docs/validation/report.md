...
Generated by `tools/plot_comparison.py` on 2026-09-25 for 8 datasets (`hip_model.m`: pelvis, right femur and tibia, auto2020 joints, 64 kg).
...
* The Python mesh is at least as faithful as MATLAB's (mean distance) for **22 of 24** bones.
...
| bone | faces (python / matlab / original) | mean py / ml [mm] | max py / ml [mm] |
|---|---|---|---|
| pelvis | 23506 / 23506 / 78356 | 0.024 / 0.035 | 0.17 / 0.55 |
| femur | 11220 / 11220 / 37404 | 0.023 / 0.036 | 1.00 / 1.55 |
| tibia | 10578 / 10578 / 35260 | 0.026 / 0.041 | 1.64 / 2.55 |

![MSKPIPE_CT deviation maps](maps_MSKPIPE_CT.png)

![MSKPIPE_CT histograms](hist_MSKPIPE_CT.png)
